...
<!-- This file is generated from param.xweb --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
<!-- ********************************************************************
...
div.annotation-close { position: absolute;
  ...
  <xsl:param name="annotation.graphic.close">http://docbook.sourceforge.net/release/images/annot-close.png</xsl:param>
...
set       toc,title</xsl:param>
  ...
  <xsl:param name="link.mailto.url" select="0"/>
  ...
  <xsl:param name="olink.base.uri" select="0"/>
